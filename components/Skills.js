    ...
    <div className={styles.container}>
      ...
      <div className={styles['skills-container']}>
        ...
        >
          ...
          <div className={styles['skills-levels-wrapper']}>
            <span className={styles['skills-level-text']}>
              Networking <i className={styles['level-val']}>{networking}</i>
            </span>
            <div className={styles['level-bar-wrapper']}>
              <div
                className={styles['level-bar bar3']}
                style={{ width: networking }}
              ></div>
            </div>
          </div>
          <div className={styles['skills-levels-wrapper level-on-view']}>
            <span className={styles['skills-level-text']}>
              Digital Security / IT Consultancy{' '}
              <i className={styles['level-val']}>{consultancy}</i>
            </span>
            <div className={styles['level-bar-wrapper']}>
              <div
                className={styles['level-bar bar4']}
                style={{ width: consultancy }}
              ></div>
            </div>
          </div>
        </div>
