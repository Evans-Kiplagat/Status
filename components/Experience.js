    ...
    return (
      <div>
        <div className={`${styles.technologiesWrapper}`}>
          <div>
            <FiPlay className={styles.pointIcon} />
          </div>
          <p className={styles.technologyText}>{data}</p>
        </div>
      </div>
    );
  });
            ...
            return (
              <div>
                <div className={`${styles.technologiesWrapper}`}>
                  ...
                  <p className={styles.technologyText}>{work}</p>
                </div>
              </div>
            );
          })}
    ...
    >
      ...
      <div className={styles.workWrapper}>
        ...
        <div className={styles.workDetails}>
          <p className={styles.roleText}>
            {' '}
            {experienceProvider[index].position}{' '}
            <a
              href={`${experienceProvider[index].link}`}
              target='_blank'
              rel='noopener noreferrer'
              className={styles.companyName}
            >
              {experienceProvider[index].organization}
            </a>
          </p>
