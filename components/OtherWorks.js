    ...
    <div className={styles.container}>
      ...
      <div className={styles.projectsWrapper}>
        <div className={styles.projectContainer} data-aos='zoom-in'>
          ...
          <a
            href='https://virtuoussprouts.org'
            target='_blank'
          ...
          <p className={styles.aboutProject}>
            This is a web application used by Virtuous Sprouts for student
            registration and result portal
          </p>
        ...
        <div className={styles.projectContainer} data-aos='zoom-in'>
          <img src='/assets/stack.svg' className={styles.stackIcon} />
          <a
            href='https://play.google.com/store/apps/details?id=com.gtbank.appdev.orangetoolboxv1'
            target='_blank'
            rel='noopener noreferrer'
          >
            <FiExternalLink className={styles.linkIcon} />
          ...
          <p className={styles.aboutProject}>
            This is a mobile app used by the GTBank's staff majorly marketers to
            ease banking and solving customers' issues outside the bank
          </p>
          <div className={styles.projectToolsWrapper}>
        ...
        <div className={styles.projectContainer} data-aos='zoom-in'>
          <img src='/assets/stack.svg' className={styles.stackIcon} />
          <a
            href='https://countrydet.netlify.app/'
            target='_blank'
            rel='noopener noreferrer'
          >
            <FiExternalLink className={styles.linkIcon} />
          ...
          <p className={styles.aboutProject}>
            A web application that provides users with countries details and
            their neighbouring country. search can be done by country search or
            by continents
          </p>
          <div className={styles.projectToolsWrapper}>
            <p className={styles.toolName}>React</p>
        ...
        <div className={styles.projectContainer} data-aos='zoom-in'>
          <img src='/assets/stack.svg' className={styles.stackIcon} />
          <a
            href='https://drive.google.com/file/d/1pRg9vZrelncG5n_0UzjVESI2TWzllaeH/view?usp=sharing'
            target='_blank'
            rel='noopener noreferrer'
          >
            <FiExternalLink className={styles.linkIcon} />
          ...
          <p className={styles.aboutProject}>
            This is a rhyme mobile app built for children for learning the
            English letters
          </p>
          <div className={styles.projectToolsWrapper}>
        ...
        <div className={styles.projectContainer} data-aos='zoom-in'>
          <img src='/assets/stack.svg' className={styles.stackIcon} />
          <a
            href='https://newcoretechnologies.com'
            target='_blank'
            rel='noopener noreferrer'
          >
            <FiExternalLink className={styles.linkIcon} />
        ...
        <div className={styles.projectContainer} data-aos='zoom-in'>
          <img src='/assets/stack.svg' className={styles.stackIcon} />
          <a
            href='https://gtdashboard.herokuapp.com'
            target='_blank'
            rel='noopener noreferrer'
          >
            <FiExternalLink className={styles.linkIcon} />
          ...
          <p className={styles.aboutProject}>
            This is an internal web app for monitoring servers with
            auto-notification and server uptime and downtime analysis.
          </p>
          <div className={styles.projectToolsWrapper}>
