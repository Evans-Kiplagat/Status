const experienceProvider = [
  ...
  },
  {
    ...
    date: '2021 - 2023',
    workDone: [
      'Designing and delivering a comprehensive game that interact with web3.',
      'Build SDK and libraries that are used by game developer to intergrate games to blockchain ecosystem.',
      'Define new UI/UX in the game to intergrate to an new feature',
      'Emphasizing collaboration, CI/CD pipelines, and Infrastructure as Code (IaC) concepts.',
      'Providing individualized guidance, monitored progress, and provinding consulting services to other campanies.',
    ],
  },
  {
    position: 'Software Engineer',
